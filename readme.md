...
### довставляем ноды (относится все еще к апдейту)

---

Попутно на каждом шаге при проходе по `cA[]` мы помечали элементы из `bA[]` как заафекченные - получим следующий результат
...
Оставшимися непомеченными элементами будут элементы, которых не было на клиенте (значит они новые)
