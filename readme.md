...
После каждого свапа пересчитываем нумерацию двух задействованных нод
...
Так как размерность итогово массива поменялся мы должно пройти по всем нодам ниже вставленной (все после Note 7), и применить операцию инкремента нашей нумерации
...
Проходим по всему массиву выставляя нумерацию
